...
#include "PracticePenetrationAvoidanceFeeler.h"
#include "DrawDebugHelpers.h"
#include "PracticeCameraMode_ThirdPerson.generated.h"

class UCurveVector;

/**
 * UPracticeCameraMode_ThirdPerson
 *
 *	A basic third person camera mode.
 */
UCLASS(Abstract, Blueprintable)
class UPracticeCameraMode_ThirdPerson : public UPracticeCameraMode
{
	GENERATED_BODY()
...
public:
	...
	TArray<FPracticePenetrationAvoidanceFeeler> PenetrationAvoidanceFeelers;
