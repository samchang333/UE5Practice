...
struct UE5PRACTICE_API FPracticeContextEffects
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class UE5PRACTICE_API UPracticeActiveContextEffects : public UObject
{
	GENERATED_BODY()
...
class UE5PRACTICE_API UPracticeContextEffectsLibrary : public UObject
{
	GENERATED_BODY()
