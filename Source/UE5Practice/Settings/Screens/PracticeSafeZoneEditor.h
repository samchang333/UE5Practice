...
#include "PracticeSafeZoneEditor.generated.h"
...
UCLASS(Abstract)
class UPracticeSafeZoneEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	UPracticeSafeZoneEditor(const FObjectInitializer& Initializer);
