...
#include "PracticeSettingValueDiscrete_OverallQuality.h"

#include "Engine/Engine.h"
#include "Settings/PracticeSettingsLocal.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(PracticeSettingValueDiscrete_OverallQuality)

#define LOCTEXT_NAMESPACE "PracticeSettings"

UPracticeSettingValueDiscrete_OverallQuality::UPracticeSettingValueDiscrete_OverallQuality()
{
}

void UPracticeSettingValueDiscrete_OverallQuality::OnInitialized()
{
	Super::OnInitialized();
...
void UPracticeSettingValueDiscrete_OverallQuality::StoreInitial()
{
}

void UPracticeSettingValueDiscrete_OverallQuality::ResetToDefault()
{
}

void UPracticeSettingValueDiscrete_OverallQuality::RestoreToInitial()
{
}

void UPracticeSettingValueDiscrete_OverallQuality::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 UPracticeSettingValueDiscrete_OverallQuality::GetDiscreteOptionIndex() const
{
...
TArray<FText> UPracticeSettingValueDiscrete_OverallQuality::GetDiscreteOptions() const
{
	const int32 OverallQualityLevel = GetOverallQualityLevel();
	if (OverallQualityLevel == INDEX_NONE)
	{
...
int32 UPracticeSettingValueDiscrete_OverallQuality::GetCustomOptionIndex() const
{
	return OptionsWithCustom.Num() - 1;
}

int32 UPracticeSettingValueDiscrete_OverallQuality::GetOverallQualityLevel() const
{
