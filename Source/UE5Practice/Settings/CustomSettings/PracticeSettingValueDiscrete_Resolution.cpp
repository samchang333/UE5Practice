...
#include "PracticeSettingValueDiscrete_Resolution.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(PracticeSettingValueDiscrete_Resolution)

#define LOCTEXT_NAMESPACE "PracticeSettings"

UPracticeSettingValueDiscrete_Resolution::UPracticeSettingValueDiscrete_Resolution()
{
}

void UPracticeSettingValueDiscrete_Resolution::OnInitialized()
{
	Super::OnInitialized();
...
void UPracticeSettingValueDiscrete_Resolution::StoreInitial()
{
	// Ignored
}

void UPracticeSettingValueDiscrete_Resolution::ResetToDefault()
{
	// Ignored
}

void UPracticeSettingValueDiscrete_Resolution::RestoreToInitial()
{
	// Ignored
}

void UPracticeSettingValueDiscrete_Resolution::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 UPracticeSettingValueDiscrete_Resolution::GetDiscreteOptionIndex() const
{
...
TArray<FText> UPracticeSettingValueDiscrete_Resolution::GetDiscreteOptions() const
{
...
void UPracticeSettingValueDiscrete_Resolution::OnDependencyChanged()
{
...
void UPracticeSettingValueDiscrete_Resolution::InitializeResolutions()
{
	Resolutions.Empty();
...
void UPracticeSettingValueDiscrete_Resolution::SelectAppropriateResolutions()
{
...
bool UPracticeSettingValueDiscrete_Resolution::ShouldAllowFullScreenResolution(const FScreenResolutionRHI& SrcScreenRes, int32 FilterThreshold) const
{
...
int32 UPracticeSettingValueDiscrete_Resolution::FindIndexOfDisplayResolution(const FIntPoint& InPoint) const
{
...
int32 UPracticeSettingValueDiscrete_Resolution::FindIndexOfDisplayResolutionForceValid(const FIntPoint& InPoint) const
{
...
int32 UPracticeSettingValueDiscrete_Resolution::FindClosestResolutionIndex(const FIntPoint& Resolution) const
{	
	int32 Index = 0;
...
void UPracticeSettingValueDiscrete_Resolution::GetStandardWindowResolutions(const FIntPoint& MinResolution, const FIntPoint& MaxResolution, float MinAspectRatio, TArray<FIntPoint>& OutResolutions)
{
...
FText UPracticeSettingValueDiscrete_Resolution::FScreenResolutionEntry::GetDisplayText() const
{
