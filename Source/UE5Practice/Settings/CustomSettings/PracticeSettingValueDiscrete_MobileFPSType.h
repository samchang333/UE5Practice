...
//#include "Settings/PracticeMobilePerformance.h"
#include "GameSettingValueDiscrete.h"

#include "PracticeSettingValueDiscrete_MobileFPSType.generated.h"
...
UCLASS()
class UPracticeSettingValueDiscrete_MobileFPSType : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	UPracticeSettingValueDiscrete_MobileFPSType();
