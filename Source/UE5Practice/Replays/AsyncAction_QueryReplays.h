...
class UPracticeReplayList;
class UObject;
struct FEnumerateStreamsResult;
struct FFrame;

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FQueryReplayAsyncDelegate, UPracticeReplayList*, Results);
...
private:
	UPROPERTY()
	TObjectPtr<UPracticeReplayList> ResultList;
