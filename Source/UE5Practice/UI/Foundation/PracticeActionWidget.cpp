...
#include "PracticeActionWidget.h"
...
FSlateBrush UPracticeActionWidget::GetIcon() const
{
...
UEnhancedInputLocalPlayerSubsystem* UPracticeActionWidget::GetEnhancedInputSubsystem() const
{
