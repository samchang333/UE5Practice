...
#include "PracticeReticleWidgetBase.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(PracticeReticleWidgetBase)

UPracticeReticleWidgetBase::UPracticeReticleWidgetBase(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

void UPracticeReticleWidgetBase::InitializeFromWeapon(UPracticeWeaponInstance* InWeapon)
{
	WeaponInstance = InWeapon;
	InventoryInstance = nullptr;
	if (WeaponInstance)
	{
		InventoryInstance = Cast<UPracticeInventoryItemInstance>(WeaponInstance->GetInstigator());
	}
	OnWeaponInitialized();
}


float UPracticeReticleWidgetBase::ComputeSpreadAngle() const
{
	if (const UPracticeRangedWeaponInstance* RangedWeapon = Cast<const UPracticeRangedWeaponInstance>(WeaponInstance))
	{
...
bool UPracticeReticleWidgetBase::HasFirstShotAccuracy() const
{
	if (const UPracticeRangedWeaponInstance* RangedWeapon = Cast<const UPracticeRangedWeaponInstance>(WeaponInstance))
	{
...
float UPracticeReticleWidgetBase::ComputeMaxScreenspaceSpreadRadius() const
{
