...
#include "PracticeBotCreationComponent.generated.h"
...
class UPracticeBotCreationComponent : public UGameStateComponent
{
	GENERATED_BODY()

public:
	UPracticeBotCreationComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
