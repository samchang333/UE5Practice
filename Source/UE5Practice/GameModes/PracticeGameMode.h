 ...
 */
DECLARE_MULTICAST_DELEGATE_TwoParams(FOnPracticeGameModePlayerInitialized, AGameModeBase* /*GameMode*/, AController* /*NewPlayer*/);
...
class APracticeGameMode : public AModularGameModeBase
{
	GENERATED_BODY()

public:

	APracticeGameMode(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	UFUNCTION(BlueprintCallable, Category = "Practice|Pawn")
	const UPracticePawnData* GetPawnDataForController(const AController* InController) const;
	...
	FOnPracticeGameModePlayerInitialized OnGameModePlayerInitialized;
