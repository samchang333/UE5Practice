...
#include "PracticeInputModifiers.h"

#include "EnhancedPlayerInput.h"
#include "GameFramework/PlayerController.h"
#include "Input/PracticeAimSensitivityData.h"
#include "Player/PracticeLocalPlayer.h"
#include "Settings/PracticeSettingsShared.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(PracticeInputModifiers)

DEFINE_LOG_CATEGORY_STATIC(LogPracticeInputModifiers, Log, All);

//////////////////////////////////////////////////////////////////////
// PracticeInputModifiersHelpers

namespace PracticeInputModifiersHelpers
{
	/** Returns the owning PracticeLocalPlayer of an Enhanced Player Input pointer */
	static UPracticeLocalPlayer* GetLocalPlayer(const UEnhancedPlayerInput* PlayerInput)
	{
		if (PlayerInput)
		{
			if (APlayerController* PC = Cast<APlayerController>(PlayerInput->GetOuter()))
			{
				return Cast<UPracticeLocalPlayer>(PC->GetLocalPlayer());
			}
		}
		return nullptr;
	}
...
//////////////////////////////////////////////////////////////////////
// UPracticeSettingBasedScalar

FInputActionValue UPracticeSettingBasedScalar::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	...
	{
		if (UPracticeLocalPlayer* LocalPlayer = PracticeInputModifiersHelpers::GetLocalPlayer(PlayerInput))
		{
			const UClass* SettingsClass = UPracticeSettingsShared::StaticClass();
			UPracticeSettingsShared* SharedSettings = LocalPlayer->GetSharedSettings();
...
//////////////////////////////////////////////////////////////////////
// UPracticeInputModifierDeadZone

FInputActionValue UPracticeInputModifierDeadZone::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	EInputActionValueType ValueType = CurrentValue.GetValueType();
	UPracticeLocalPlayer* LocalPlayer = PracticeInputModifiersHelpers::GetLocalPlayer(PlayerInput);
	if (ValueType == EInputActionValueType::Boolean || !LocalPlayer)
	{
		return CurrentValue;
	}
	
	UPracticeSettingsShared* Settings = LocalPlayer->GetSharedSettings();
	ensure(Settings);
...
FLinearColor UPracticeInputModifierDeadZone::GetVisualizationColor_Implementation(FInputActionValue SampleValue, FInputActionValue FinalValue) const
{
...
//////////////////////////////////////////////////////////////////////
// UPracticeInputModifierGamepadSensitivity

FInputActionValue UPracticeInputModifierGamepadSensitivity::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	...
	const EPracticeGamepadSensitivity Sensitivity = (TargetingType == EPracticeTargetingType::Normal) ? Settings->GetGamepadLookSensitivityPreset() : Settings->GetGamepadTargetingSensitivityPreset();
...
//////////////////////////////////////////////////////////////////////
// UPracticeInputModifierAimInversion

FInputActionValue UPracticeInputModifierAimInversion::ModifyRaw_Implementation(const UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime)
{
	UPracticeLocalPlayer* LocalPlayer = PracticeInputModifiersHelpers::GetLocalPlayer(PlayerInput);
	if (!LocalPlayer)
	{
