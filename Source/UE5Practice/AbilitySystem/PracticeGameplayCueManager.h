...
#include "PracticeGameplayCueManager.generated.h"
...
/**
 * UPracticeGameplayCueManager
 *
 * Game-specific manager for gameplay cues
 */
UCLASS()
class UPracticeGameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()

public:
	UPracticeGameplayCueManager(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	static UPracticeGameplayCueManager* Get();
