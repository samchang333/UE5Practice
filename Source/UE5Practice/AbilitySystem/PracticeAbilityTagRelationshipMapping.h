...
#include "PracticeAbilityTagRelationshipMapping.generated.h"

class UObject;

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FPracticeAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class UPracticeAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FPracticeAbilityTagRelationship> AbilityTagRelationships;
