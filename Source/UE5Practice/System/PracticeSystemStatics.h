...
#include "PracticeSystemStatics.generated.h"
...
UCLASS()
class UPracticeSystemStatics : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category="Practice", meta = (WorldContext = "WorldContextObject"))
