...
#include "PracticePlatformEmulationSettings.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(PracticePlatformEmulationSettings)

#define LOCTEXT_NAMESPACE "PracticeCheats"

UPracticePlatformEmulationSettings::UPracticePlatformEmulationSettings()
{
}

FName UPracticePlatformEmulationSettings::GetCategoryName() const
{
	return FApp::GetProjectName();
}

FName UPracticePlatformEmulationSettings::GetPretendBaseDeviceProfile() const
{
	return PretendBaseDeviceProfile;
}

FName UPracticePlatformEmulationSettings::GetPretendPlatformName() const
{
	return PretendPlatform;
}

#if WITH_EDITOR
void UPracticePlatformEmulationSettings::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void UPracticePlatformEmulationSettings::PostReloadConfig(FProperty* PropertyThatWasLoaded)
{
...
void UPracticePlatformEmulationSettings::PostInitProperties()
{
...
void UPracticePlatformEmulationSettings::OnPlayInEditorStarted() const
{
...
void UPracticePlatformEmulationSettings::ApplySettings()
{
...
void UPracticePlatformEmulationSettings::ChangeActivePretendPlatform(FName NewPlatformName)
{
...
TArray<FName> UPracticePlatformEmulationSettings::GetKnownPlatformIds() const
{
...
TArray<FName> UPracticePlatformEmulationSettings::GetKnownDeviceProfiles() const
{
	TArray<FName> Results;
...
void UPracticePlatformEmulationSettings::PickReasonableBaseDeviceProfile()
{
