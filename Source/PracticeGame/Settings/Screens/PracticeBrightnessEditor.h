...
#include "PracticeBrightnessEditor.generated.h"
...
UCLASS(Abstract)
class UPracticeBrightnessEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	UPracticeBrightnessEditor(const FObjectInitializer& Initializer);
