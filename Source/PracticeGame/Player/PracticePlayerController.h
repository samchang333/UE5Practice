...
class PRACTICEGAME_API APracticePlayerController : public ACommonPlayerController, public IPracticeCameraAssistInterface, public IPracticeTeamAgentInterface
{
	GENERATED_BODY()
