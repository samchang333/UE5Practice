...
public:
	...
	TObjectPtr<UPracticeInventoryItemInstance> Item = nullptr;
};
...
public:
	...
	static void AddPickupToInventory(UPracticeInventoryManagerComponent* InventoryComponent, TScriptInterface<IPickupable> Pickup);
};
