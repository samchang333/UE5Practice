...
#include "PracticeExperienceDefinition.h"
#include "GameFeatureAction.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(PracticeExperienceDefinition)

#define LOCTEXT_NAMESPACE "PracticeSystem"

UPracticeExperienceDefinition::UPracticeExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult UPracticeExperienceDefinition::IsDataValid(TArray<FText>& ValidationErrors)
{
...
void UPracticeExperienceDefinition::UpdateAssetBundleData()
{
