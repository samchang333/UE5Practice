...
#include "PracticeCosmeticAnimationTypes.generated.h"
...
struct FPracticeAnimLayerSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FPracticeAnimLayerSelectionSet
{
	GENERATED_BODY()
	...
	TArray<FPracticeAnimLayerSelectionEntry> LayerRules;
...
USTRUCT(BlueprintType)
struct FPracticeAnimBodyStyleSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FPracticeAnimBodyStyleSelectionSet
{
	GENERATED_BODY()
		
	// List of layer rules to apply, first one that matches will be used
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta=(TitleProperty=Mesh))
	TArray<FPracticeAnimBodyStyleSelectionEntry> MeshRules;
