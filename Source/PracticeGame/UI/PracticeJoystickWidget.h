...
#include "PracticeJoystickWidget.generated.h"
 ...
 */
UCLASS(meta=( DisplayName="Practice Joystick" ))
class PRACTICEGAME_API UPracticeJoystickWidget : public UPracticeSimulatedInputWidget
{
	GENERATED_BODY()
	
public:
	
	UPracticeJoystickWidget(const FObjectInitializer& ObjectInitializer);
