...
#include "PracticeGameViewportClient.h"

#include "CommonUISettings.h"
#include "ICommonUIModule.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(PracticeGameViewportClient)
...
UPracticeGameViewportClient::UPracticeGameViewportClient()
	: Super(FObjectInitializer::Get())
{
}

void UPracticeGameViewportClient::Init(struct FWorldContext& WorldContext, UGameInstance* OwningGameInstance, bool bCreateNewAudioDevice)
{
