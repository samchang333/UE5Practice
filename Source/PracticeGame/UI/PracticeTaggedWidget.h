...
#include "PracticeTaggedWidget.generated.h"
...
class UPracticeTaggedWidget : public UCommonUserWidget
{
	GENERATED_BODY()

public:
	UPracticeTaggedWidget(const FObjectInitializer& ObjectInitializer);
