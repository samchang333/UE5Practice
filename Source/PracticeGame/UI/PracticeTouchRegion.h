...
#include "PracticeTouchRegion.generated.h"
 ...
 */
UCLASS(meta=( DisplayName="Practice Touch Region" ))
class PRACTICEGAME_API UPracticeTouchRegion : public UPracticeSimulatedInputWidget
{
	GENERATED_BODY()
