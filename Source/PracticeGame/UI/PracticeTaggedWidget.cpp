...
#include "PracticeTaggedWidget.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(PracticeTaggedWidget)

//@TODO: The other TODOs in this file are all related to tag-based showing/hiding of widgets, see UE-142237

UPracticeTaggedWidget::UPracticeTaggedWidget(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

void UPracticeTaggedWidget::NativeConstruct()
{
...
void UPracticeTaggedWidget::NativeDestruct()
{
	if (!IsDesignTime())
	{
...
void UPracticeTaggedWidget::SetVisibility(ESlateVisibility InVisibility)
{
...
void UPracticeTaggedWidget::OnWatchedTagsChanged()
{
	const bool bHasHiddenTags = false;//@TODO: Foo->HasAnyTags(HiddenByTags);
