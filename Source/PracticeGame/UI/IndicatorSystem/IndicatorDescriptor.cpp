...
void UIndicatorDescriptor::SetIndicatorManagerComponent(UPracticeIndicatorManagerComponent* InManager)
{
...
{
	if (UPracticeIndicatorManagerComponent* Manager = ManagerPtr.Get())
	{
