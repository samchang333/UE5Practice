...
class PRACTICEGAME_API UIndicatorDescriptor : public UObject
{
	GENERATED_BODY()
...
public:
	UPracticeIndicatorManagerComponent* GetIndicatorManagerComponent() { return ManagerPtr.Get(); }
	void SetIndicatorManagerComponent(UPracticeIndicatorManagerComponent* InManager);
...
private:
	...
	UPROPERTY()
	TWeakObjectPtr<UPracticeIndicatorManagerComponent> ManagerPtr;
