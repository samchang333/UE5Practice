...
#include "PracticeSimulatedInputWidget.generated.h"
 ...
 */
UCLASS(meta=( DisplayName="Practice Simulated Input Widget" ))
class PRACTICEGAME_API UPracticeSimulatedInputWidget : public UCommonUserWidget
{
	GENERATED_BODY()
	
public:
	
	UPracticeSimulatedInputWidget(const FObjectInitializer& ObjectInitializer);
