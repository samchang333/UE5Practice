...
#include "PracticeWeaponInstance.generated.h"
...
/**
 * UPracticeWeaponInstance
 *
 * A piece of equipment representing a weapon spawned and applied to a pawn
 */
UCLASS()
class UPracticeWeaponInstance : public UPracticeEquipmentInstance
{
	GENERATED_BODY()

public:
	UPracticeWeaponInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	FPracticeAnimLayerSelectionSet EquippedAnimSet;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=Animation)
	FPracticeAnimLayerSelectionSet UneuippedAnimSet;
