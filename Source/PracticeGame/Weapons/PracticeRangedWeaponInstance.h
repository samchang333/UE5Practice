...
#include "PracticeRangedWeaponInstance.generated.h"

class UPhysicalMaterial;

/**
 * UPracticeRangedWeaponInstance
 *
 * A piece of equipment representing a ranged weapon spawned and applied to a pawn
 */
UCLASS()
class UPracticeRangedWeaponInstance : public UPracticeWeaponInstance, public IPracticeAbilitySourceInterface
{
	GENERATED_BODY()

public:
	UPracticeRangedWeaponInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
public:
	...
	//~UPracticeEquipmentInstance interface
	virtual void OnEquipped();
	virtual void OnUnequipped();
	//~End of UPracticeEquipmentInstance interface

	void AddSpread();

	//~IPracticeAbilitySourceInterface interface
	...
	//~End of IPracticeAbilitySourceInterface interface
