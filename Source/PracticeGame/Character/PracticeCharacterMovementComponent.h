...
PRACTICEGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Gameplay_MovementStopped);
 ...
 */
UCLASS(Config = Game)
class PRACTICEGAME_API UPracticeCharacterMovementComponent : public UCharacterMovementComponent
{
	GENERATED_BODY()
