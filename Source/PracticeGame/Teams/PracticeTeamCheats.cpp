...
#include UE_INLINE_GENERATED_CPP_BY_NAME(PracticeTeamCheats)

//////////////////////////////////////////////////////////////////////
// UPracticeTeamCheats

void UPracticeTeamCheats::CycleTeam()
{
...
void UPracticeTeamCheats::SetTeam(int32 TeamID)
{
	if (UPracticeTeamSubsystem* TeamSubsystem = UWorld::GetSubsystem<UPracticeTeamSubsystem>(GetWorld()))
	{
...
void UPracticeTeamCheats::ListTeams()
{
	if (UPracticeTeamSubsystem* TeamSubsystem = UWorld::GetSubsystem<UPracticeTeamSubsystem>(GetWorld()))
	{
		const TArray<int32> TeamIDs = TeamSubsystem->GetTeamIDs();
