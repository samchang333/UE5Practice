...
#include "PracticeNumberPopComponent_MeshText.h"
...
#include "PracticeDamagePopStyle.h"
#include "Materials/MaterialInstanceDynamic.h"
#include "TimerManager.h"
#include "UObject/Package.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(PracticeNumberPopComponent_MeshText)

class UStaticMesh;

UPracticeNumberPopComponent_MeshText::UPracticeNumberPopComponent_MeshText(const FObjectInitializer& ObjectInitializer)
...
void UPracticeNumberPopComponent_MeshText::AddNumberPop(const FPracticeNumberPopRequest& NewRequest)
{
...
void UPracticeNumberPopComponent_MeshText::ReleaseNextComponents()
{
	UWorld* LocalWorld = GetWorld();
	check(LocalWorld);
...
FLinearColor UPracticeNumberPopComponent_MeshText::DetermineColor(const FPracticeNumberPopRequest& Request) const
{
	for (UPracticeDamagePopStyle* Style : Styles)
	{
...
UStaticMesh* UPracticeNumberPopComponent_MeshText::DetermineStaticMesh(const FPracticeNumberPopRequest& Request) const
{
	for (UPracticeDamagePopStyle* Style : Styles)
	{
...
void UPracticeNumberPopComponent_MeshText::SetMaterialParameters(const FPracticeNumberPopRequest& Request, FTempNumberPopInfo& NewDamageNumberInfo, const FTransform& CameraTransform, const FVector& NumberLocation)
{
