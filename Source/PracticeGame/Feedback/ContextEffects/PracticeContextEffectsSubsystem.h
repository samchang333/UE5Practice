...
class PRACTICEGAME_API UPracticeContextEffectsSettings : public UDeveloperSettings
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class PRACTICEGAME_API UPracticeContextEffectsSet : public UObject
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class PRACTICEGAME_API UPracticeContextEffectsSubsystem : public UWorldSubsystem
{
	GENERATED_BODY()
