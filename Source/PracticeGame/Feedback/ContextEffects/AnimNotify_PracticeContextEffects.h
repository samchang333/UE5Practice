...
struct PRACTICEGAME_API FPracticeContextEffectAnimNotifyVFXSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct PRACTICEGAME_API FPracticeContextEffectAnimNotifyAudioSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct PRACTICEGAME_API FPracticeContextEffectAnimNotifyTraceSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct PRACTICEGAME_API FPracticeContextEffectAnimNotifyPreviewSettings
{
	GENERATED_BODY()
...
class PRACTICEGAME_API UAnimNotify_PracticeContextEffects : public UAnimNotify
{
	GENERATED_BODY()
