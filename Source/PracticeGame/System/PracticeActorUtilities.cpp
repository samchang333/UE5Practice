...
#include "PracticeActorUtilities.h"

#include "GameFramework/Actor.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(PracticeActorUtilities)

EBlueprintExposedNetMode UPracticeActorUtilities::SwitchOnNetMode(const UObject* WorldContextObject)
{
