...
UCLASS(Config = Game)
class PRACTICEGAME_API UPracticeGameInstance : public UCommonGameInstance
{
	GENERATED_BODY()

public:

	UPracticeGameInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	APracticePlayerController* GetPrimaryPlayerController() const;
