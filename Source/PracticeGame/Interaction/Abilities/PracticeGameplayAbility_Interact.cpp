...
#include "PracticeGameplayAbility_Interact.h"
...
#include "UI/IndicatorSystem/PracticeIndicatorManagerComponent.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(PracticeGameplayAbility_Interact)
...
UPracticeGameplayAbility_Interact::UPracticeGameplayAbility_Interact(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	ActivationPolicy = EPracticeAbilityActivationPolicy::OnSpawn;
	InstancingPolicy = EGameplayAbilityInstancingPolicy::InstancedPerActor;
	NetExecutionPolicy = EGameplayAbilityNetExecutionPolicy::LocalPredicted;
}

void UPracticeGameplayAbility_Interact::ActivateAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo, const FGameplayEventData* TriggerEventData)
{
...
void UPracticeGameplayAbility_Interact::UpdateInteractions(const TArray<FInteractionOption>& InteractiveOptions)
{
	if (APracticePlayerController* PC = GetPracticePlayerControllerFromActorInfo())
	{
		if (UPracticeIndicatorManagerComponent* IndicatorManager = UPracticeIndicatorManagerComponent::GetComponent(PC))
		{
...
void UPracticeGameplayAbility_Interact::TriggerInteraction()
{
