...
#include "PracticeNotificationMessage.generated.h"

class UObject;

PRACTICEGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Practice_AddNotification_Message);

class APlayerState;

// A message destined for a transient log (e.g., an elimination feed or inventory pickup stream)
USTRUCT(BlueprintType)
struct PRACTICEGAME_API FPracticeNotificationMessage
{
	GENERATED_BODY()
