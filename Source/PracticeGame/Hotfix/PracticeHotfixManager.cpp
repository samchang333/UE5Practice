...
#include "PracticeHotfixManager.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(PracticeHotfixManager)

int32 UPracticeHotfixManager::GameHotfixCounter = 0;

UPracticeHotfixManager::UPracticeHotfixManager()
{
#if !UE_BUILD_SHIPPING
	OnScreenMessageHandle = FCoreDelegates::OnGetOnScreenMessages.AddUObject(this, &UPracticeHotfixManager::GetOnScreenMessages);
...
void UPracticeHotfixManager::Init()
{
	Super::Init();
}

void UPracticeHotfixManager::OnHotfixCompleted(EHotfixResult HotfixResult)
{
	...
	if (bHasPendingDeviceProfileHotfix)
	{
		...
		UPracticeSettingsLocal* GameSettings = UPracticeSettingsLocal::Get();
...
bool UPracticeHotfixManager::WantsHotfixProcessing(const FCloudFileHeader& FileHeader)
{
...
bool UPracticeHotfixManager::HotfixIniFile(const FString& FileName, const FString& IniData)
{
...
bool UPracticeHotfixManager::ApplyHotfixProcessing(const FCloudFileHeader& FileHeader)
{
...
bool UPracticeHotfixManager::ShouldWarnAboutMissingWhenPatchingFromIni(const FString& AssetPath) const
{
	return AssetPath.StartsWith(TEXT("/Engine/")) || AssetPath.StartsWith(TEXT("/Game/"));
}

void UPracticeHotfixManager::PatchAssetsFromIniFiles()
{
#if ENABLE_SHARED_MEMORY_TRACKER
...
void UPracticeHotfixManager::OnHotfixAvailablityCheck(const TArray<FCloudFileHeader>& PendingChangedFiles, const TArray<FCloudFileHeader>& PendingRemoveFiles)
{
...
bool UPracticeHotfixManager::PreProcessDownloadedFileData(TArray<uint8>& FileData) const
{
...
#if !UE_BUILD_SHIPPING
void UPracticeHotfixManager::GetOnScreenMessages(TMultiMap<FCoreDelegates::EOnScreenMessageSeverity, FText>& OutMessages)
{
	// TODO Any messages/errors.
}
#endif // !UE_BUILD_SHIPPING

void UPracticeHotfixManager::RequestPatchAssetsFromIniFiles()
{
...
void UPracticeHotfixManager::StartHotfixProcess()
{
	if (GIsEditor)
	{
