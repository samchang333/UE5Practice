...
class PRACTICEGAME_API UPracticePickupDefinition : public UDataAsset
{
	GENERATED_BODY()
...
class PRACTICEGAME_API UPracticeWeaponPickupDefinition : public UPracticePickupDefinition
{
	GENERATED_BODY()
